...
type NetworkTransport struct {
	...
	msgCh chan interface{} // msgCh is used to transfer data between NetworkTransport and outer variable (e.g., Node)
...
func (n *NetworkTransport) MsgChan() chan interface{} {
	return n.msgCh
}
